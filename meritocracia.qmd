...
school_merit_pref <- proc_datos %>% ggplot(aes(x=school_merit_pref)) + 
  ...
  geom_text(aes(label = ..count..), stat = "count", colour = "black", 
    vjust = -0.7, position = position_dodge(.9), size =3) 
...
curso <- proc_datos %>% ggplot(aes(x=school_merit_pref, fill = curso_estudiante)) + 
  geom_bar()+ 
  labs(x = "Preferencia de mérito en la escuela", 
       y = "Frecuencia" )   +
  scale_x_continuous(breaks = c(0, 5, 10), labels = c("Esfuerzo", "Ambos", "Talento")) +
  theme_classic() + 
  ggtitle("Figura 1.31: Preferencia de acuerdo al curso")  + 
  labs(fill = NULL) +
  scale_fill_brewer(palette = "Blues") +
  theme(plot.title = element_text(size = 12,
    face = "italic", 
...
gen <- proc_datos %>% ggplot(aes(x=school_merit_pref, fill = genero_ES)) + 
  geom_bar()+ 
  labs(x = "Preferencia de mérito en la escuela", 
       y = "Frecuencia" )   +
  scale_x_continuous(breaks = c(0, 5, 10), labels = c("Esfuerzo", "Ambos", "Talento")) +
  theme_classic() +
  ggtitle("Figura 1.30: Preferencia de acuerdo al género del estudiante")  + 
  labs(fill = NULL) + 
...
nepa <- proc_datos %>% ggplot(aes(x=school_merit_pref, fill = educ_max)) + 
  geom_bar()+ 
  labs(x = "Preferencia de mérito en la escuela", 
       y = "Frecuencia" )   +
  scale_x_continuous(breaks = c(0, 5, 10), labels = c("Esfuerzo", "Ambos", "Talento")) +
  theme_classic() +
   labs(fill = NULL) + 
  ggtitle("Figura 1.32: Preferencia de acuerdo al nivel educacional del hogar")  + 
  scale_fill_brewer(palette = "Blues") +
  theme(plot.title = element_text(size = 12,
    face = "italic", 
    color = "#8B7D7B", hjust = 0.5),
...
libros <- proc_datos %>% ggplot(aes(x=school_merit_pref, fill = libros_hogar)) + 
  geom_bar()+ 
  labs(x = "Preferencia de mérito en la escuela", 
       y = "Frecuencia" )   +
  scale_x_continuous(breaks = c(0, 5, 10), labels = c("Esfuerzo", "Ambos", "Talento")) +
  theme_classic() +
   labs(fill = NULL) + 
  ggtitle("Figura 1.33: Preferencia de acuerdo a la cantidad de libros en el hogar") + 
  scale_fill_brewer(palette = "Blues") +
  theme(plot.title = element_text(size = 12,
    face = "italic", 
    color = "#8B7D7B", hjust = 0.5),
...
notas_merit_final <- ggarrange(
  plot_notas_merit,
  curso_notas_merit,
  common.legend = TRUE, 
  nrow = 2, 
  legend = "bottom",
  legend.grob = get_legend(plot_notas_merit, "bottom"))

# Agregar una etiqueta global centrada
plot_notas_merit_final <- annotate_figure(
  notas_merit_final,
  top = text_grob(
    "Figura 1.34: ¿Te parece que este promedio fue más o menos de lo que merecías?",
    size = 12, 
    face = "italic", 
    color = "#8B7D7B",
    hjust = 0.5))
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(notas_merit))) +
  ...
  labs(
    ...
    y = NULL, # Elimina el título del eje y
    fill = "Grado de acuerdo",
    title = "Figura 1.35: ¿Te parece que este promedio fue más o menos de lo que merecías?"
  ) +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),  # Ocultar etiquetas del eje y
...
plot_notas_esfuerzo_final<- ggarrange(
  plot_notas_esfuerzo, 
  curso_notas_esfuerzo,
  common.legend = TRUE, 
  nrow = 2, 
  legend = "bottom",
  legend.grob = get_legend(plot_notas_esfuerzo, "bottom"))

# Agregar una etiqueta global centrada
final_plot_notas_es <- annotate_figure(
  plot_notas_esfuerzo_final,
  top = text_grob(
    "Figura 1.36: Tomando en cuenta el tiempo que le dedicas a tus estudios,\nlas notas que me saco son…",
    size = 12, 
    face = "italic", 
    color = "#8B7D7B",
    hjust = 0.5
...
final_plot_notas_es # generamos el grafico
```
...
ggplot(frecuencias, aes(x = categoria, y = Porcentaje, fill = factor(notas_esfuerzo))) +
  ...
  labs(
    ...
    y = NULL, # Elimina el título del eje y
    fill = "Grado de acuerdo",
    title = "Figura 1.37: Tomando en cuenta el tiempo que le dedicas a tus estudios,\nlas notas que me saco son…"
  ) +
  theme_blank() +
  theme(
    axis.text.y = element_blank(),  # Ocultar etiquetas del eje y
...
final_plot <- cowplot::plot_grid(
  cowplot::plot_grid(NULL, annotate_figure(
    combined_plot,
    top = text_grob(
      "Figura 1.38: Contraste entre la nota obtenida y la nota preferida\npor el estudiante",
      size = 12, 
      face = "italic", 
      color = "#8B7D7B",
      hjust = 0.5
...
```{r, echo=FALSE}
#tabla_cruzada <- sjt.xtab(datos$p4, 
                         # datos$d2, 
                          #show.col.prc = TRUE,
                          #show.summary = FALSE)
#tabla_cruzada

#tabla_cruzada1 <- sjt.xtab(datos$p5, 
                          #datos$d2, 
                          #show.col.prc = TRUE,
                          #show.summary = FALSE)
#tabla_cruzada1
