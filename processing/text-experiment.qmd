...
Hay 129 casos que no cumplen el Check de comprensión. \
...
reg03 <- glm(check_comprension~genero+curso_estudiante, data=data, family = "binomial")

texreg::knitreg(list(reg01, reg02, reg03))
```
